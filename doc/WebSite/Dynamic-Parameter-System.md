...
*InputType: A UI input type for the feature. This can be defined, and then used while creating an automatic feature screen. For example: [SingleLineStringInputType](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/UI/Inputs/SingleLineStringInputType.cs), [ComboboxInputType](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/UI/Inputs/ComboboxInputType.cs), [CheckboxInputType](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/UI/Inputs/CheckboxInputType.cs)*
...
You can use [**IDynamicPropertyManager**](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/IDynamicPropertyManager.cs) to manage dynamic property. (It uses cache)
...
You can use [**IDynamicPropertyValueManager**](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/IDynamicPropertyValueManager.cs) to manage dynamic property values. (It checks permissions)
...
You can use [**IDynamicEntityPropertyManager**](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/IDynamicEntityPropertyManager.cs) to manage entities dynamic properties. (It uses cache and checks required permissions.) See also: [DynamicEntityPropertyManagerExtensions](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/Extensions/DynamicEntityPropertyManagerExtensions.cs)
...
You can use [**IDynamicEntityPropertyValueManager**](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/IDynamicEntityPropertyValueManager.cs) to manage entities dynamic properties. (It uses cache and checks required permissions.) See also: [DynamicEntityPropertyValueManagerExtensions](https://github.com/sendevman/ASP.NET/blob/dev/src/Abp/DynamicEntityProperties/Extensions/DynamicEntityPropertyValueManagerExtensions.cs)
