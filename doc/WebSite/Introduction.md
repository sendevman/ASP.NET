...
ASP.NET Boilerplate (**ABP**) is an **[open source](https://github.com/sendevman/ASP.NET)** and well-documented **application framework**.
...
* Use [the GitHub repository](https://github.com/sendevman/ASP.NET) to access the latest **source code**, create [issues](https://github.com/sendevman/ASP.NET/issues) and send [pull requests](https://github.com/sendevman/ASP.NET/pulls).
